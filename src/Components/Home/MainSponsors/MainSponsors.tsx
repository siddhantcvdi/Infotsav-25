...
const MainSponsors: React.FC = () => {
    ...
    return (
        <section className="relative w-full min-h-screen bg-gradient-to-b from-black to-[#090928] text-white overflow-hidden pb-16">
            ...
            <h2 className="text-6xl md:text-7xl lg:text-8xl font-cattedrale text-center pt-12 relative z-10">
                SPONSORS
            </h2>

            <div className="hidden md:flex justify-center gap-12 mt-10 relative z-10">
                <div className="w-[13%] max-sm:w-[30%] max-md:w-[20%] aspect-square bg-white/10 border-white/20 border-[3px] rounded-full flex items-center justify-center p-4">
                    <img
                ...
                <div className="w-[13%] max-sm:w-[30%] max-md:w-[20%] aspect-square bg-white/10 border-white/20 border-[3px] rounded-full flex items-center justify-center p-4">
                    <img
                        ...
                        alt={homeTitleSponsers[1]?.alt || 'Union Bank Logo'}
                        className="w-full h-full object-contain"
                    />
                </div>
            </div>
